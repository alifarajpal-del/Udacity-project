#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# */AIPND-revision/intropy-project-classify-pet-images/calculates_results_stats.py
#                                                                             
...
#          (results_stats_dic) that's created as a dictionary of dictionaries.
#          This allows the results statistics to be categorized based on 
#          what type of statistic they are calculating. 
...
def calculates_results_stats(results_dic):
    ...
    # Loop through results_dic to count statistics
    ...
    # Handle division by zero for non-dog images
